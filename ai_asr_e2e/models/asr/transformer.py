...
"""
-------------------------------------------------
   Description :  ASR模型的transformer函数
   Author :       saksim
...
class Encoder(nn.Module):
    """
    自编码解码器的编码转化类：Encoder Transformer class
    """
...
class EncoderLayer(nn.Module):
    """
    自编码解码器的编码层类：Encoder Layer Transformer class
    """
